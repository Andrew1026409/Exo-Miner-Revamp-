    ...
    {   
        float3 worldPos;
            ...
            #endif
        #endif
        #if defined(INTERRA_OBJECT) || defined(INTERRA_MESH_TERRAIN) || defined(TRIPLANAR) || defined(_TERRAIN_TRIPLANAR_ONE)
            float3 worldNormal;
...
float _InTerra_GlobalSmoothness;
    ...
    #if defined(_NORMALMAPS) && !defined(_TERRAIN_NORMAL_IN_MASK) && !defined(TERRAIN_BASEGEN)
        sampler2D _Normal0;
    #endif
#endif
